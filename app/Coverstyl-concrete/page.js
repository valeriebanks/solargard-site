...
import { ConcreteData } from "../Data-Sheets/Concrete-Data";
...
export default function ConcreteMaterials() {
  const itemsPerPage = 16;
  const [currentPage, setCurrentPage] = useState(1);
  const totalPages = Math.ceil(
    ConcreteData[0]?.materials?.length / itemsPerPage
  );
