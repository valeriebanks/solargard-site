...
export default function VehicleFlyoutMenu() {
      ...
      {({ open }) => (
        <div onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
          <Popover.Button className="flex items-center gap-x-1 lg:text-sm xl:text-base xxl:text-base nav:text-sm font-semibold text-secondary">
            <span className="hover:text-HoverColor">
          ...
          {isOpen && (
            ...
            >
              <div className="w-[350px] max-w-md flex-auto overflow-hidden rounded-3xl bg-white text-base shadow-lg ring-1 ring-gray-900/5">
                <div className="p-4">
